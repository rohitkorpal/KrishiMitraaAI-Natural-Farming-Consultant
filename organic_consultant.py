...
LANGUAGES = {
    ...
    "Hindi / हिंदी": {"code": "hi", "name": "Hindi (हिंदी)"},
    "Marathi / मराठी": {"code": "mr", "name": "Marathi (मराठी)"},
    "Telugu / తెలుగు": {"code": "te", "name": "Telugu (తెలుగు)"},
    "Tamil / தமிழ்": {"code": "ta", "name": "Tamil (தமிழ்)"},
    "Kannada / ಕನ್ನಡ": {"code": "kn", "name": "Kannada (ಕನ್ನಡ)"},
    "Bengali / বাংলা": {"code": "bn", "name": "Bengali (বাংলা)"},
    "Punjabi / ਪੰਜਾਬੀ": {"code": "pa", "name": "Punjabi (ਪੰਜਾਬੀ)"},
    "Gujarati / ગુજરાતી": {"code": "gu", "name": "Gujarati (ગુજરાતી)"}
}
...
MENU_TRANSLATIONS = {
    "English": {
        ...
        "crop": "🌾 Crop & Seed Guidance",
        "disease": "🐛 Organic Disease Control",
        "weather": "🌦️ Weather & Market Intel",
        "academy": "📚 Natural Farming Academy"
    },
    "Hindi / हिंदी": {
        "title": "मॉड्यूल चुनें",
        "voice": "🎙️ वॉइस असिस्टेंट",
        "crop": "🌾 फसल और बीज मार्गदर्शन",
        "disease": "🐛 जैविक रोग नियंत्रण",
        "weather": "🌦️ मौसम और मंडी भाव",
        "academy": "📚 प्राकृतिक खेती अकादमी"
    },
    "Marathi / मराठी": {
        "title": "मॉड्यूल निवडा",
        "voice": "🎙️ व्हॉइस असिस्टंट",
        "crop": "🌾 पीक आणि बियाणे मार्गदर्शन",
        "disease": "🐛 सेंद्रिय रोग नियंत्रण",
        "weather": "🌦️ हवामान आणि बाजार माहिती",
        "academy": "📚 नैसर्गिक शेती अकादमी"
    },
    "Telugu / తెలుగు": {
        "title": "మాడ్యూల్‌ను ఎంచుకోండి",
        "voice": "🎙️ వాయిస్ అసిస్టెంట్",
        "crop": "🌾 పంట & విత్తన మార్గదర్శకత్వం",
        "disease": "🐛 సేంద్రీయ తెగుళ్ల నివారణ",
        "weather": "🌦️ వాతావరణ & మార్కెట్ సమాచారం",
        "academy": "📚 సహజ వ్యవసాయ అకాడమీ"
    },
    "Tamil / தமிழ்": {
        "title": "தொகுதியைத் தேர்ந்தெடுக்கவும்",
        "voice": "🎙️ குரல் உதவியாளர்",
        "crop": "🌾 பயிர் & விதை வழிகாட்டுதல்",
        "disease": "🐛 இயற்கை நோய் கட்டுப்பாடு",
        "weather": "🌦️ வானிலை & சந்தை தகவல்",
        "academy": "📚 இயற்கை வேளாண்மை அகாடமி"
    },
    "Kannada / ಕನ್ನಡ": {
        "title": "ಮಾಡ್ಯೂಲ್ ಆಯ್ಕೆಮಾಡಿ",
        "voice": "🎙️ ಧ್ವನಿ ಸಹಾಯಕ",
        "crop": "🌾 ಬೆಳೆ ಮತ್ತು ಬೀಜ ಮಾರ್ಗದರ್ಶನ",
        "disease": "🐛 ಸಾವಯವ ರೋಗ ನಿಯಂತ್ರಣ",
        "weather": "🌦️ ಹವಾಮಾನ ಮತ್ತು ಮಾರುಕಟ್ಟೆ ಮಾಹಿತಿ",
        "academy": "📚 ನೈಸರ್ಗಿಕ ಕೃಷಿ ಅಕಾಡೆಮಿ"
    },
    "Bengali / বাংলা": {
        "title": "মডিউল নির্বাচন করুন",
        "voice": "🎙️ ভয়েস অ্যাসিস্ট্যান্ট",
        "crop": "🌾 ফসল ও বীজ নির্দেশিকা",
        "disease": "🐛 জৈব রোগ নিয়ন্ত্রণ",
        "weather": "🌦️ আবহাওয়া ও বাজারের তথ্য",
        "academy": "📚 প্রাকৃতিক চাষ একাডেমি"
    },
    "Punjabi / ਪੰਜਾਬੀ": {
        "title": "ਮੋਡੀਊਲ ਚੁਣੋ",
        "voice": "🎙️ ਵੌਇਸ ਅਸਿਸਟੈਂਟ",
        "crop": "🌾 ਫਸਲ ਅਤੇ ਬੀਜ ਮਾਰਗਦਰਸ਼ਨ",
        "disease": "🐛 ਜੈਵਿਕ ਰੋਗ ਨਿਯੰਤਰਣ",
        "weather": "🌦️ ਮੌਸਮ ਅਤੇ ਮੰਡੀ ਦੀ ਜਾਣਕਾਰੀ",
        "academy": "📚 ਕੁਦਰਤੀ ਖੇਤੀ ਅਕੈਡਮੀ"
    },
    "Gujarati / ગુજરાતી": {
        "title": "મોડ્યુલ પસંદ કરો",
        "voice": "🎙️ વોઈસ આસિસ્ટન્ટ",
        "crop": "🌾 પાક અને બીજ માર્ગદર્શન",
        "disease": "🐛 જૈવિક રોગ નિયંત્રણ",
        "weather": "🌦️ હવામાન અને બજાર માહિતી",
        "academy": "📚 કુદરતી ખેતી એકેડેમી"
    }
}
...
is_hindi = lang == "Hindi / हिंदी"
tts_lang = LANGUAGES[lang]["code"]
target_lang = LANGUAGES[lang]["name"]
...
# Map selected menu back to canonical keys
menu_canonical = "Voice Assistant"
for key, trans in menu_trans.items():
    if menu == trans:
        if key == "voice":
            menu_canonical = "Voice Assistant"
        elif key == "crop":
            menu_canonical = "Crop & Seed Guidance"
        elif key == "disease":
            menu_canonical = "Organic Disease Control"
        elif key == "weather":
...
# -----------------------------------------------
elif menu_canonical == "Crop & Seed Guidance":
...
# -----------------------------------------------
elif menu_canonical == "Organic Disease Control":
    ...
    st.markdown(f"<p>{ 'Choose either the traditional lookup or upload a leaf photo for AI-powered organic diagnosis.' if not is_hindi else 'पारंपरिक लुकअप का उपयोग करें या एआई-संचालित जैविक निदान के लिए पत्ती की फोटो अपलोड करें।' }</p>", unsafe_allow_html=True)
    
    tab_lookup, tab_ai = st.tabs([
        "🔍 Traditional Lookup" if not is_hindi else "🔍 पारंपरिक लुकअप",
        "📸 AI Smart Leaf Diagnosis" if not is_hindi else "📸 एआई स्मार्ट पत्ती निदान"
    ])
    ...
    with tab_lookup:
        ...
        col1, col2 = st.columns(2)
        with col1:
            sel_crop = st.selectbox("Select Crop / फसल चुनें", crops_list, key="db_crop_select")
        with col2:
            sel_pest = st.selectbox("Select Disease/Pest | बीमारी/कीट चुनें", pests_list, key="db_pest_select")
            
        if st.button("Get Organic Remedy" if not is_hindi else "जैविक उपचार प्राप्त करें", key="db_remedy_btn"):
...
<p style="font-size:1.05rem;">{remedy_data['prevention']}</p>
    ...
    with tab_ai:
        st.write("Upload a clear photo of the infected crop leaf or stem, and our AI will diagnose the issue and provide natural remedies.")
        
        uploaded_file = st.file_uploader("📸 Upload Leaf Image / फोटो अपलोड करें", type=["jpg", "jpeg", "png"], key="leaf_file_uploader")
        ...
        if uploaded_file is not None:
            ...
            # Show image preview
            st.image(image_bytes, caption="Uploaded Leaf Image", width=350)
            
            if st.button("AI Diagnose & Suggest Remedies" if not is_hindi else "एआई निदान और उपचार प्राप्त करें", key="ai_remedy_btn"):
                api_key = get_api_key()
                if not api_key:
                    ...
                    with st.spinner("Analyzing image... / छवि का विश्लेषण कर रहे हैं..."):
                        ...
                        st.markdown(f"""<div class="glass-card" style="border-left: 5px solid #74c69d; margin-top:20px;">
<h3 style="color:#74c69d; margin-top:0;">{ 'AI Diagnostic Report' if not is_hindi else 'एआई निदान रिपोर्ट' }</h3>
<p style="font-size:1.05rem; line-height:1.6; color:#e8f5e9; white-space: pre-wrap;">{ai_response}</p>
</div>""", unsafe_allow_html=True)
...
# -----------------------------------------------
elif menu_canonical == "Weather & Market Intel":
...
# -----------------------------------------------
elif menu_canonical == "Natural Farming Academy":
